  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_foto">Начало церемонии <br /> 15.20</p>
        <p className="timetable__text timetable__text_about_glasses">Welcome <br /> 16:20</p>
        <p className="timetable__text timetable__text_about_plate">Свадебный ужин <br /> 16.40</p>
        <p className="timetable__text timetable__text_about_cake">Свадебный торт <br /> 21.00</p>
        <p className="timetable__text timetable__text_about_car">Окончание вечера 21.30</p>
      </div>
    </section>
  );
}
